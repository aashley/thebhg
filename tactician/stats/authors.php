...
$tacticians = array(9=>106, 12=>183, 18=>160, 19=>95, 22=>108, 28=>257, 31=>1622, 33=>135, 51=>666, 1000=>275);
...
if ($authors_result && mysql_num_rows($authors_result)) {
	...
	foreach ($tacticians as $tact) {
		...
		$table->AddHeader(roster_link($tact, $words[0]));
	}
	$table->EndRow();
	$row_no = 0;
	$last_oms = 0;
