...
echo '<TR><TH CLASS="RIGHT">Base Hull:</TH><TD><A HREF="item.php?id=' . $item->GetID() . '">' . $item->GetName() . '</A></TD></TR>';
echo '<TR><TH CLASS="RIGHT">Length:</TH><TD>' . number_format($item->GetLength()) . " $len_plural</TD></TR>";
...
echo '<TABLE CELLSPACING=1 CELLPADDING=2>';
echo '<TR><TH COLSPAN=2>Specifications</TH></TR>';
echo '<TR><TH CLASS="RIGHT">Consumables:</TH><TD>' . number_format($cons) . ' day' . ($cons > 1 ? 's' : '') . '</TD></TR>';
echo '<TR><TH CLASS="RIGHT">Hull:</TH><TD>' . number_format($hull) . ' RU</TD></TR>';
echo '<TR><TH CLASS="RIGHT">Shields:</TH><TD>' . number_format($shields) . ' SBD</TD></TR>';
echo '<TR><TH CLASS="RIGHT">Speed:</TH><TD>' . number_format($speed) . ' MGLT</TD></TR>';
echo '<TR><TH CLASS="RIGHT">Acceleration:</TH><TD>' . number_format($accel) . ' MGLT/sec</TD></TR>';
echo '<TR><TH CLASS="RIGHT">Maneuverability:</TH><TD>' . number_format($turn) . ' DPF</TD></TR>';
echo '<TR><TH CLASS="RIGHT">Hyperdrive Factor:</TH><TD>';
if ($hyper < 1000) echo 'x' . number_format($hyper, 2);
else echo 'No hyperdrive fitted';
echo '</TD></TR>';
echo '<TR><TH CLASS="RIGHT">Power:</TH><TD>' . number_format(-1 * $power) . ' units available</TD></TR>';
