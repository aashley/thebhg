...
function do_form() {
	...
	$position_disp_max .= '</SELECT>';
		...
		echo <<<EOF1
<FORM NAME="add_item" METHOD="post" ACTION="$PHP_SELF" ENCTYPE="multipart/form-data">
...
<TR><TD>Price:</TD><TD><INPUT TYPE="text" NAME="price" SIZE=10 VALUE="0"> ICs</TD></TR>
<TR><TD>Length:</TD><TD><INPUT TYPE="text" NAME="length" SIZE=5 VALUE="0"> metres</TD></TR>
<TR><TD>Hull Strength:</TD><TD><INPUT TYPE="text" NAME="hull" SIZE=5 VALUE="0"> RUs</TD></TR>
<TR><TD>People:</TD><TD><INPUT TYPE="text" NAME="people" SIZE=5 VALUE="0"></TD></TR>
<TR><TD>Sales Limit:</TD><TD><INPUT TYPE="text" NAME="limit" SIZE=5 VALUE="0"> (0 = unlimited)</TD></TR>
<TR><TD>Sell as complete $str_singular only:</TD><TD><INPUT TYPE="checkbox" NAME="shiponly" VALUE="on"></TD></TR>
...
if (isset($name)) {
	...
	$shiponly = ($shiponly == 'on' ? true : false);
	if ($type->AddItem($name, $price, $length, $hull, $people, $min, $max, $restriction, $description, $limit, $shiponly, $image, $itype)) {
