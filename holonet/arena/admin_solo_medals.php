<?php
function title() {
    return 'Administration :: Solo Missions :: Award Medals';
}
...
function output() {
    ...
    if (isset($_REQUEST['submit'])){
	    ...
	    for ($i = 0; $i < 10; $i++) {
			...
			$mb->AwardMedal($awarded, $hunter, next_medal($awarded, $_REQUEST[$medal]), 'Commissioner of the Bounty Office: '.$_REQUEST['reason']);
