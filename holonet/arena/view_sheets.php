...
function output() {
	...
	if (!isset($_REQUEST['name'])) $_REQUEST['name'] = 'char';
	if (!isset($_REQUEST['kabal'])) $_REQUEST['kabal'] = 'all';
	if (!isset($_REQUEST['order'])) $_REQUEST['order'] = 'name';
	if (!isset($_REQUEST['list'])) $_REQUEST['list'] = 'az';
