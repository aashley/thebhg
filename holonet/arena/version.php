...
function output() {
    ...
    echo "Last Update: Fixed some minor ATN problems. Fixed credit award problems. Higher ups can award creds quickly to RP Aides, and added the ACNC. Also took away the ACN link to Starfield Arena Challenges. This will come back when the SSL is refit, and it is at this time the ACNC will be up for use.";
