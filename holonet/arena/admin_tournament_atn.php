<?php
function title() {
    return 'Administration :: Arena Tournament :: Add Matches to ATN';
}
...
function output() {
    ...
    if (isset($_REQUEST['submit'])) {
	    ...
	    if ($at->AddToATN($_REQUEST['location'], $_REQUEST['rules'], $_REQUEST['posts'], $_REQUEST['num_weapon'], $_REQUEST['type_weapon'])){
	        ...
	        echo 'Error! <b>Please submit the following error code to the <a href="http://bugs.thebhg.org/">Bug Tracker</a></b><br />NEC Error Code: 107';
	    }
