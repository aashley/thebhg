...
function title() {
    ...
    return 'AMS Tracking Network :: Solo Mission :: Contracts';
}
...
function output() {
    ...
    foreach($arena->SoloContracts() as $value){
        ...
        '<a href="' . internal_link('atn_solo_contract', array('id'=>$value->GetID())) . '">ATN Stats</a> | '.$value->ArenaLink());
    }
