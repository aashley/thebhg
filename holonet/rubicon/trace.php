...
if (isset($_REQUEST['hhcbqa'])){
	...
	if ($_REQUEST['yad'] == '2552-1231-235-233'){
		...
		echo 'var text = "<tt>passcode accepted<br /><br />Tracing route<br />...<br />...<br />...<br />...<br />...<br />[127.215.1927.1952] holonet_terminal{rra}_kuat<br />[17123.1241.73245.1235] subspace_router{laa}_zeltros<br />[217.1285.123.731587] routing_trml{jha}_toydaria<br />[1581.1925.8341.8123:8322] server_core{KVA}_shadda<br />...<br />...<br />...<br />trace complete<br /><br />holonet::__loadSpike(\'/specialist/spike4.spk\')<br /><br />spikeRout protocol initiated<br />...<br />...<br />...<br />Done<br /><br />holonet::__loadCache(\'/local.trcrt.log\')"';
	} else {
		$time = time() + (60 * 30);
		setcookie('bhg_hashk', md5(time()), $time);
		echo "var yes = 0\n";
		echo "var pause = 1\n";
		echo 'var text = "<tt>incorrect passcode<br />...<br />...possible slicing attempt<br />...<br />...spiking signal<br />...<br />...<br />traceback spike ping initiated<br />...<br />...<br />...<br />...<br >...<br />...ident invalid. Locking out resource ID<br />...Terminating<br />...<br />...<br />Connection Terminated<br />"';
	}
	...
	echo 'var text = "<tt>ping resolve on id beginning"';
} elseif (isset($_REQUEST['kad'])){
	if (in_array($_REQUEST['kad'], array(2292, 2154, 1600, 2687))){
		echo "var cernun = '&fiz'\n";
		echo 'var text = "<tt>id ping successful. Tracing route<br />...<br />...<br />...<br />...<br />...<br />[122.1239.1235.123] holonet_terminal{kasa}_solrahl<br />[127.0.0.1] routing_trml{asa}_pltalon<br />[12841.1231.21418.212] subspace_router{jha}_firrerre<br />[182.2125.231.1231] subspace_router{jga}_moorja<br />[12312.734.862.258] holonet_terminal{kkd}_duro<br /><br />...trace pause...<br /><br />...<br />...<br />system requires validation to continue traceroute<br />...<br />"';
		
	} else {
		echo "var yes = 0\n";
		echo 'var text = "<tt>cannot resolve ping...<br />...<br />...<br /><br />Terminating<br />...<br />...<br />Connection Terminated<br />"';
	}
	...
	echo "var cernun = '&pxr'\n";
	echo 'var text = "<tt>entering passcode:<br />****-****-****<br />validating<br />...<br />...<br />...<br />approved<br /><br />Successfully logged in to RubicoNet Server 129K9 [LYARNA-GUILD]<br /><br />...<br />..."';
