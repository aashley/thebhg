<?php
	...
	/**
	 * Smarty {getnextentry} function plugin
	 *
	 * Type:     function<br>
	 * Name:     getnextentry<br>
	 * Date:     Dec 31, 2003<br>
	 * Purpose:  return the entry immediatly after the entry given<br>
	 * Input:<br>
	 ...
	 *
	 * Examples: {getnextentry blogid=1 year=2003 month=12 day=31}
	 * @author   Thomas Reynolds <Thomas.Reynolds@asu.edu>
	 * @param array
	 * @param Smarty
	 * @return array
	 */
	function smarty_function_getnextentry ($params, &$smarty) 
	{
		...
		if (empty ($params['blogid']))
			$smarty->trigger_error ('getnextentry: blogid or categoryid is a required parameter');
		...
		// If there is no next entry, abort
		if ($result->numRows () <= 0)
		{
