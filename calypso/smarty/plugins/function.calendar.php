...
// +----------------------------------------------------------------------+
//
// $Id: function.calendar.php,v 1.1 2004/01/14 05:08:43 khylari Exp $
...
function smarty_function_calendar($params, &$smarty)
{
  ...
  if (empty($params['year']))
	$params['year'] = $today_array['year'];

  if (empty($params['month']))
	$params['month'] = $today_array['mon'];

  if (empty($params['day']))
	$params['day'] = $today_array['mday'];
