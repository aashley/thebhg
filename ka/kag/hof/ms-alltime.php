...
?>
			<div>
				<h2>KAG Hall of Fame :: Most Master's Shields (All-Time)</h2>
...
$result = mysql_query('SELECT person, COUNT(DISTINCT id) AS shields FROM kag_signups WHERE state > 0 AND rank = 1 GROUP BY person ORDER BY shields DESC LIMIT 10', $db);
