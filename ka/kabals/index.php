...
<?	$kabals = $roster->GetKabals(1);
 ...
 ?>
			...
			<table cellpadding="0" cellspacing="0" class="invisible">
				<tr>
					<td colspan="2">Chief: <b><?=$chief->GetName()?></b> - <b><a shref="mailto:<?=$chief->GetEMail()?>"><?=$chief->GetEMail()?></a></b></td> <td colSpan="4" rowspan="6" width="82" ><img src="<?=$kabal->getlogourl()?>"></td>
				</tr>
				<tr>
