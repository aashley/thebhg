<? require_once '../Layout.inc'; ?>
			<div>
				...
				<p>Bounty Hunter; I must welcome you to the Kabal Authority Headquarters.
				  This is the very heart of the Bounty Hunter's Guild. My name is <a href="http://holonet.thebhg.org/index.php?module=roster&page=hunter&id=<?=$ward->GetID()?>" title="View the roster profile for Warden <?=$ward->GetName()?>"><?=$ward->GetName()?></a> and 
				  I run the Kabal Authority; with some help from each kabal's chief. Not only
