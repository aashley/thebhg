...
$result = mysql_query('SELECT person, SUM(points) AS points, COUNT(DISTINCT id) AS events, COUNT(DISTINCT cg) AS cgs FROM cg_signups WHERE state > 0 GROUP BY person ORDER BY points DESC, events ASC LIMIT 10', $db);
